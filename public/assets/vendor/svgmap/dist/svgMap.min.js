...
! function i(s, a, r) {
    function h(t, l) {
        if (!a[t]) {
            ...
            s[t][0].call(n.exports, function(l) {
                return h(s[t][1][l] || l)
            }, n, n.exports, i, s, a, r)
        }
        return a[t].exports
    }
    for (var L = "function" == typeof require && require, l = 0; l < r.length; l++) h(r[l]);
    return h
}({
    1: [function(l, t, e) {
        var i = l("./svg-utilities");
        t.exports = {
            enable: function(l) {
                var t = l.svg.querySelector("defs");
                if (t || (t = document.createElementNS(i.svgNS, "defs"), l.svg.appendChild(t)), !t.querySelector("style#svg-pan-zoom-controls-styles")) {
                    var e = document.createElementNS(i.svgNS, "style");
                    e.setAttribute("id", "svg-pan-zoom-controls-styles"), e.setAttribute("type", "text/css"), e.textContent = ".svg-pan-zoom-control { cursor: pointer; fill: black; fill-opacity: 0.333; } .svg-pan-zoom-control:hover { fill-opacity: 0.8; } .svg-pan-zoom-control-background { fill: white; fill-opacity: 0.5; } .svg-pan-zoom-control-background { fill-opacity: 0.8; }", t.appendChild(e)
                }
                var o = document.createElementNS(i.svgNS, "g");
                o.setAttribute("id", "svg-pan-zoom-controls"), o.setAttribute("transform", "translate(" + (l.width - 70) + " " + (l.height - 76) + ") scale(0.75)"), o.setAttribute("class", "svg-pan-zoom-control"), o.appendChild(this._createZoomIn(l)), o.appendChild(this._createZoomReset(l)), o.appendChild(this._createZoomOut(l)), l.svg.appendChild(o), l.controlIcons = o
            },
            _createZoomIn: function(l) {
                ...
                t.setAttribute("id", "svg-pan-zoom-zoom-in"), t.setAttribute("transform", "translate(30.5 5) scale(0.015)"), t.setAttribute("class", "svg-pan-zoom-control"), t.addEventListener("click", function() {
                    l.getPublicInstance().zoomIn()
                }, !1), t.addEventListener("touchstart", function() {
                    l.getPublicInstance().zoomIn()
                }, !1);
                var e = document.createElementNS(i.svgNS, "rect");
                e.setAttribute("x", "0"), e.setAttribute("y", "0"), e.setAttribute("width", "1500"), e.setAttribute("height", "1400"), e.setAttribute("class", "svg-pan-zoom-control-background"), t.appendChild(e);
            ...
            _createZoomReset: function(l) {
                ...
                t.setAttribute("id", "svg-pan-zoom-reset-pan-zoom"), t.setAttribute("transform", "translate(5 35) scale(0.4)"), t.setAttribute("class", "svg-pan-zoom-control"), t.addEventListener("click", function() {
                    l.getPublicInstance().reset()
                }, !1), t.addEventListener("touchstart", function() {
                    l.getPublicInstance().reset()
                }, !1);
                var e = document.createElementNS(i.svgNS, "rect");
                e.setAttribute("x", "2"), e.setAttribute("y", "2"), e.setAttribute("width", "182"), e.setAttribute("height", "58"), e.setAttribute("class", "svg-pan-zoom-control-background"), t.appendChild(e);
                var o = document.createElementNS(i.svgNS, "path");
            ...
            disable: function(l) {
                l.controlIcons && (l.controlIcons.parentNode.removeChild(l.controlIcons), l.controlIcons = null)
            }
        }
    }, {
        "./svg-utilities": 5
    ...
    2: [function(l, t, e) {
        var o = l("./svg-utilities"),
            s = l("./utilities"),
            n = function(l, t) {
                this.init(l, t)
            };
        n.prototype.init = function(l, t) {
            this.viewport = l, this.options = t, this.originalState = {
                zoom: 1,
                x: 0,
                y: 0
            }, this.activeState = {
                ...
                x: 0,
                y: 0
            }, this.updateCTMCached = s.proxy(this.updateCTM, this), this.requestAnimationFrame = s.createRequestAnimationFrame(this.options.refreshRate), this.viewBox = {
                x: 0,
                y: 0,
                width: 0,
                height: 0
            }, this.cacheViewBox();
            var e = this.processCTM();
            this.setCTM(e), this.updateCTM()
        }, n.prototype.cacheViewBox = function() {
            var l = this.options.svg.getAttribute("viewBox");
            if (l) {
                var t = l.split(/[\s\,]/).filter(function(l) {
                    return l
                }).map(parseFloat);
                this.viewBox.x = t[0], this.viewBox.y = t[1], this.viewBox.width = t[2], this.viewBox.height = t[3];
                var e = Math.min(this.options.width / this.viewBox.width, this.options.height / this.viewBox.height);
                this.activeState.zoom = e, this.activeState.x = (this.options.width - this.viewBox.width * e) / 2, this.activeState.y = (this.options.height - this.viewBox.height * e) / 2, this.updateCTMOnNextFrame(), this.options.svg.removeAttribute("viewBox")
            } else this.simpleViewBoxCache()
        }, n.prototype.simpleViewBoxCache = function() {
            var l = this.viewport.getBBox();
            this.viewBox.x = l.x, this.viewBox.y = l.y, this.viewBox.width = l.width, this.viewBox.height = l.height
        }, n.prototype.getViewBox = function() {
            return s.extend({}, this.viewBox)
        }, n.prototype.processCTM = function() {
            var l, t = this.getCTM();
            (this.options.fit || this.options.contain) && (l = this.options.fit ? Math.min(this.options.width / this.viewBox.width, this.options.height / this.viewBox.height) : Math.max(this.options.width / this.viewBox.width, this.options.height / this.viewBox.height), t.a = l, t.d = l, t.e = -this.viewBox.x * l, t.f = -this.viewBox.y * l);
            if (this.options.center) {
                var e = .5 * (this.options.width - (this.viewBox.width + 2 * this.viewBox.x) * t.a),
            ...
            return s.extend({}, this.originalState)
        }, n.prototype.getState = function() {
            return s.extend({}, this.activeState)
        }, n.prototype.getZoom = function() {
            return this.activeState.zoom
        }, n.prototype.getRelativeZoom = function() {
            return this.activeState.zoom / this.originalState.zoom
        }, n.prototype.computeRelativeZoom = function(l) {
            return l / this.originalState.zoom
            ...
            var l = this.options.svg.createSVGMatrix();
            return l.a = this.activeState.zoom, l.b = 0, l.c = 0, l.d = this.activeState.zoom, l.e = this.activeState.x, l.f = this.activeState.y, l
        }, n.prototype.setCTM = function(l) {
            var t = this.isZoomDifferent(l),
                e = this.isPanDifferent(l);
            if (t || e) {
                if (t && (!1 === this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(l.a)) ? (l.a = l.d = this.activeState.zoom, t = !1) : (this.updateCache(l), this.options.onZoom(this.getRelativeZoom()))), e) {
                    var o = this.options.beforePan(this.getPan(), {
                        ...
                        n = !1,
                        i = !1;
                    !1 === o ? (l.e = this.getPan().x, l.f = this.getPan().y, n = i = !0) : s.isObject(o) && (!1 === o.x ? (l.e = this.getPan().x, n = !0) : s.isNumber(o.x) && (l.e = o.x), !1 === o.y ? (l.f = this.getPan().y, i = !0) : s.isNumber(o.y) && (l.f = o.y)), n && i || !this.isPanDifferent(l) ? e = !1 : (this.updateCache(l), this.options.onPan(this.getPan()))
                }(t || e) && this.updateCTMOnNextFrame()
            }
        }, n.prototype.isZoomDifferent = function(l) {
            return this.activeState.zoom !== l.a
        }, n.prototype.isPanDifferent = function(l) {
            return this.activeState.x !== l.e || this.activeState.y !== l.f
        }, n.prototype.updateCache = function(l) {
            this.activeState.zoom = l.a, this.activeState.x = l.e, this.activeState.y = l.f
            ...
            var l = this.getCTM();
            o.setCTM(this.viewport, l, this.defs), this.pendingUpdate = !1, this.options.onUpdatedCTM && this.options.onUpdatedCTM(l)
    ...
    3: [function(l, t, e) {
        var o, n = l("./svg-pan-zoom.js");
        o = window, document, "function" == typeof define && define.amd ? define("svg-pan-zoom", function() {
            return n
        }) : void 0 !== t && t.exports && (t.exports = n, o.svgPanZoom = n)
    }, {
        "./svg-pan-zoom.js": 4
    }],
    4: [function(l, t, e) {
        ...
        n.prototype.init = function(l, t) {
            var e = this;
            this.svg = l, this.defs = l.querySelector("defs"), a.setupSvgAttributes(this.svg), this.options = s.extend(s.extend({}, h), t), this.state = "none";
            var o = a.getBoundingClientRectNormalized(l);
            this.width = o.width, this.height = o.height, this.viewport = r(a.getOrCreateViewport(this.svg, this.options.viewportSelector), {
                svg: this.svg,
                width: this.width,
                height: this.height,
                ...
                beforeZoom: function(l, t) {
                    if (e.viewport && e.options.beforeZoom) return e.options.beforeZoom(l, t)
                },
                onZoom: function(l) {
                    if (e.viewport && e.options.onZoom) return e.options.onZoom(l)
                },
                beforePan: function(l, t) {
                    if (e.viewport && e.options.beforePan) return e.options.beforePan(l, t)
                },
                onPan: function(l) {
                    if (e.viewport && e.options.onPan) return e.options.onPan(l)
                },
                onUpdatedCTM: function(l) {
                    if (e.viewport && e.options.onUpdatedCTM) return e.options.onUpdatedCTM(l)
                }
            });
            var n = this.getPublicInstance();
            n.setBeforeZoom(this.options.beforeZoom), n.setOnZoom(this.options.onZoom), n.setBeforePan(this.options.beforePan), n.setOnPan(this.options.onPan), n.setOnUpdatedCTM(this.options.onUpdatedCTM), this.options.controlIconsEnabled && i.enable(this), this.lastMouseWheelEventTime = Date.now(), this.setupHandlers()
        }, n.prototype.setupHandlers = function() {
            var e = this,
                o = null;
            if (this.eventListeners = {
                    mousedown: function(l) {
                        var t = e.handleMouseDown(l, o);
                        return o = l, t
                    },
                    ...
                    mouseup: function(l) {
                        return e.handleMouseUp(l)
                    },
                    touchend: function(l) {
                        return e.handleMouseUp(l)
                    },
                    mousemove: function(l) {
                        return e.handleMouseMove(l)
                    },
                ...
                if (l && l.length)
                    for (var t = l.length - 1; 0 <= t; t--) this.eventListeners.hasOwnProperty(l[t]) && delete this.eventListeners[l[t]]
            }
            for (var n in this.eventListeners)(this.options.eventsListenerElement || this.svg).addEventListener(n, this.eventListeners[n], !this.options.preventMouseEventsDefault && L);
            this.options.mouseWheelZoomEnabled && (this.options.mouseWheelZoomEnabled = !1, this.enableMouseWheelZoom())
        }, n.prototype.enableMouseWheelZoom = function() {
            if (!this.options.mouseWheelZoomEnabled) {
                var t = this;
                this.wheelListener = function(l) {
                    return t.handleMouseWheel(l)
                };
                var l = !this.options.preventMouseEventsDefault;
                o.on(this.options.eventsListenerElement || this.svg, this.wheelListener, l), this.options.mouseWheelZoomEnabled = !0
            }
        }, n.prototype.disableMouseWheelZoom = function() {
            if (this.options.mouseWheelZoomEnabled) {
                var l = !this.options.preventMouseEventsDefault;
                o.off(this.options.eventsListenerElement || this.svg, this.wheelListener, l), this.options.mouseWheelZoomEnabled = !1
            }
        }, n.prototype.handleMouseWheel = function(l) {
            if (this.options.zoomEnabled && "none" === this.state) {
                ...
                var t = l.deltaY || 1,
                    e = Date.now() - this.lastMouseWheelEventTime,
                    o = 3 + Math.max(0, 30 - e);
                this.lastMouseWheelEventTime = Date.now(), "deltaMode" in l && 0 === l.deltaMode && l.wheelDelta && (t = 0 === l.deltaY ? 0 : Math.abs(l.wheelDelta) / l.deltaY), t = -.3 < t && t < .3 ? t : (0 < t ? 1 : -1) * Math.log(Math.abs(t) + 10) / o;
                var n = this.svg.getScreenCTM().inverse(),
                    i = a.getEventPoint(l, this.svg).matrixTransform(n),
                    s = Math.pow(1 + this.options.zoomScaleSensitivity, -1 * t);
                this.zoomAtPoint(s, i)
            }
        }, n.prototype.zoomAtPoint = function(l, t, e) {
            var o = this.viewport.getOriginalState();
            e ? (l = Math.max(this.options.minZoom * o.zoom, Math.min(this.options.maxZoom * o.zoom, l)), l /= this.getZoom()) : this.getZoom() * l < this.options.minZoom * o.zoom ? l = this.options.minZoom * o.zoom / this.getZoom() : this.getZoom() * l > this.options.maxZoom * o.zoom && (l = this.options.maxZoom * o.zoom / this.getZoom());
            var n = this.viewport.getCTM(),
                i = t.matrixTransform(n.inverse()),
                s = this.svg.createSVGMatrix().translate(i.x, i.y).scale(l).translate(-i.x, -i.y),
                a = n.multiply(s);
            a.a !== n.a && this.viewport.setCTM(a)
        }, n.prototype.zoom = function(l, t) {
            this.zoomAtPoint(l, a.getSvgCenterPoint(this.svg, this.width, this.height), t)
        }, n.prototype.publicZoom = function(l, t) {
            t && (l = this.computeFromRelativeZoom(l)), this.zoom(l, t)
        }, n.prototype.publicZoomAtPoint = function(l, t, e) {
            if (e && (l = this.computeFromRelativeZoom(l)), "SVGPoint" !== s.getType(t)) {
                if (!("x" in t && "y" in t)) throw new Error("Given point is invalid");
                t = a.createSVGPoint(this.svg, t.x, t.y)
            }
            this.zoomAtPoint(l, t, e)
        }, n.prototype.getZoom = function() {
            return this.viewport.getZoom()
        }, n.prototype.getRelativeZoom = function() {
            return this.viewport.getRelativeZoom()
        }, n.prototype.computeFromRelativeZoom = function(l) {
            return l * this.viewport.getOriginalState().zoom
        }, n.prototype.resetZoom = function() {
            var l = this.viewport.getOriginalState();
            this.zoom(l.zoom, !0)
        }, n.prototype.resetPan = function() {
            this.pan(this.viewport.getOriginalState())
        }, n.prototype.reset = function() {
            this.resetZoom(), this.resetPan()
        }, n.prototype.handleDblClick = function(l) {
            var t;
            if ((this.options.preventMouseEventsDefault && (l.preventDefault ? l.preventDefault() : l.returnValue = !1), this.options.controlIconsEnabled) && -1 < (l.target.getAttribute("class") || "").indexOf("svg-pan-zoom-control")) return !1;
            t = l.shiftKey ? 1 / (2 * (1 + this.options.zoomScaleSensitivity)) : 2 * (1 + this.options.zoomScaleSensitivity);
            var e = a.getEventPoint(l, this.svg).matrixTransform(this.svg.getScreenCTM().inverse());
            this.zoomAtPoint(t, e)
        }, n.prototype.handleMouseDown = function(l, t) {
            this.options.preventMouseEventsDefault && (l.preventDefault ? l.preventDefault() : l.returnValue = !1), s.mouseAndTouchNormalize(l, this.svg), this.options.dblClickZoomEnabled && s.isDblClick(l, t) ? this.handleDblClick(l) : (this.state = "pan", this.firstEventCTM = this.viewport.getCTM(), this.stateOrigin = a.getEventPoint(l, this.svg).matrixTransform(this.firstEventCTM.inverse()))
        }, n.prototype.handleMouseMove = function(l) {
            if (this.options.preventMouseEventsDefault && (l.preventDefault ? l.preventDefault() : l.returnValue = !1), "pan" === this.state && this.options.panEnabled) {
                var t = a.getEventPoint(l, this.svg).matrixTransform(this.firstEventCTM.inverse()),
                    e = this.firstEventCTM.translate(t.x - this.stateOrigin.x, t.y - this.stateOrigin.y);
                this.viewport.setCTM(e)
            }
        }, n.prototype.handleMouseUp = function(l) {
            this.options.preventMouseEventsDefault && (l.preventDefault ? l.preventDefault() : l.returnValue = !1), "pan" === this.state && (this.state = "none")
        }, n.prototype.fit = function() {
            var l = this.viewport.getViewBox(),
                t = Math.min(this.width / l.width, this.height / l.height);
            this.zoom(t, !0)
        }, n.prototype.contain = function() {
            var l = this.viewport.getViewBox(),
                t = Math.max(this.width / l.width, this.height / l.height);
            this.zoom(t, !0)
        }, n.prototype.center = function() {
            var l = this.viewport.getViewBox(),
                t = .5 * (this.width - (l.width + 2 * l.x) * this.getZoom()),
                e = .5 * (this.height - (l.height + 2 * l.y) * this.getZoom());
            this.getPublicInstance().pan({
                x: t,
                y: e
            })
        }, n.prototype.updateBBox = function() {
            this.viewport.simpleViewBoxCache()
        }, n.prototype.pan = function(l) {
            var t = this.viewport.getCTM();
            t.e = l.x, t.f = l.y, this.viewport.setCTM(t)
        }, n.prototype.panBy = function(l) {
            var t = this.viewport.getCTM();
            t.e += l.x, t.f += l.y, this.viewport.setCTM(t)
        }, n.prototype.getPan = function() {
            ...
            var l = a.getBoundingClientRectNormalized(this.svg);
            ...
            var t = this;
            for (var l in this.beforeZoom = null, this.onZoom = null, this.beforePan = null, this.onPan = null, (this.onUpdatedCTM = null) != this.options.customEventsHandler && this.options.customEventsHandler.destroy({
                    svgElement: this.svg,
                    eventsListenerElement: this.options.eventsListenerElement,
                    instance: this.getPublicInstance()
                }), this.eventListeners)(this.options.eventsListenerElement || this.svg).removeEventListener(l, this.eventListeners[l], !this.options.preventMouseEventsDefault && L);
            this.disableMouseWheelZoom(), this.getPublicInstance().disableControlIcons(), this.reset(), u = u.filter(function(l) {
                return l.svg !== t.svg
            }), delete this.options, delete this.viewport, delete this.publicInstance, delete this.pi, this.getPublicInstance = function() {
                return null
            }
        }, n.prototype.getPublicInstance = function() {
            var e = this;
            return this.publicInstance || (this.publicInstance = this.pi = {
                ...
                panBy: function(l) {
                    return e.panBy(l), e.pi
                },
                getPan: function() {
                    return e.getPan()
                },
                setBeforePan: function(l) {
                    return e.options.beforePan = null === l ? null : s.proxy(l, e.publicInstance), e.pi
                },
                setOnPan: function(l) {
                    return e.options.onPan = null === l ? null : s.proxy(l, e.publicInstance), e.pi
                },
                enableZoom: function() {
                ...
                enableControlIcons: function() {
                    return e.options.controlIconsEnabled || (e.options.controlIconsEnabled = !0, i.enable(e)), e.pi
                },
                disableControlIcons: function() {
                    return e.options.controlIconsEnabled && (e.options.controlIconsEnabled = !1, i.disable(e)), e.pi
                },
                ...
                setZoomScaleSensitivity: function(l) {
                    return e.options.zoomScaleSensitivity = l, e.pi
                },
                setMinZoom: function(l) {
                    return e.options.minZoom = l, e.pi
                },
                setMaxZoom: function(l) {
                    return e.options.maxZoom = l, e.pi
                },
                setBeforeZoom: function(l) {
                    return e.options.beforeZoom = null === l ? null : s.proxy(l, e.publicInstance), e.pi
                },
                setOnZoom: function(l) {
                    return e.options.onZoom = null === l ? null : s.proxy(l, e.publicInstance), e.pi
                },
                zoom: function(l) {
                    return e.publicZoom(l, !0), e.pi
                },
                zoomBy: function(l) {
                    return e.publicZoom(l, !1), e.pi
                },
                zoomAtPoint: function(l, t) {
                    return e.publicZoomAtPoint(l, t, !0), e.pi
                },
                zoomAtPointBy: function(l, t) {
                    return e.publicZoomAtPoint(l, t, !1), e.pi
                },
                zoomIn: function() {
                ...
                setOnUpdatedCTM: function(l) {
                    return e.options.onUpdatedCTM = null === l ? null : s.proxy(l, e.publicInstance), e.pi
                },
                resetZoom: function() {
        ...
        t.exports = function(l, t) {
            ...
            for (var o = u.length - 1; 0 <= o; o--)
                if (u[o].svg === e) return u[o].instance.getPublicInstance();
            return u.push({
                svg: e,
                instance: new n(e, t)
    ...
    5: [function(l, t, e) {
        var r = l("./utilities"),
            i = "unknown";
        document.documentMode && (i = "ie"), t.exports = {
            svgNS: "http://www.w3.org/2000/svg",
            xmlNS: "http://www.w3.org/XML/1998/namespace",
            xmlnsNS: "http://www.w3.org/2000/xmlns/",
            xlinkNS: "http://www.w3.org/1999/xlink",
            evNS: "http://www.w3.org/2001/xml-events",
            getBoundingClientRectNormalized: function(l) {
                if (l.clientWidth && l.clientHeight) return {
                    width: l.clientWidth,
                    height: l.clientHeight
                };
                if (l.getBoundingClientRect()) return l.getBoundingClientRect();
                throw new Error("Cannot get BoundingClientRect for SVG.")
            },
            getOrCreateViewport: function(l, t) {
                var e = null;
                if (!(e = r.isElement(t) ? t : l.querySelector(t))) {
                    var o = Array.prototype.slice.call(l.childNodes || l.children).filter(function(l) {
                        return "defs" !== l.nodeName && "#text" !== l.nodeName
                    });
                    1 === o.length && "g" === o[0].nodeName && null === o[0].getAttribute("transform") && (e = o[0])
                }
                if (!e) {
                    var n = "viewport-" + (new Date).toISOString().replace(/\D/g, "");
                    (e = document.createElementNS(this.svgNS, "g")).setAttribute("id", n);
                    var i = l.childNodes || l.children;
                    if (i && 0 < i.length)
                        for (var s = i.length; 0 < s; s--) "defs" !== i[i.length - s].nodeName && e.appendChild(i[i.length - s]);
                    l.appendChild(e)
                }
                var a = [];
                return e.getAttribute("class") && (a = e.getAttribute("class").split(" ")), ~a.indexOf("svg-pan-zoom_viewport") || (a.push("svg-pan-zoom_viewport"), e.setAttribute("class", a.join(" "))), e
            },
            setupSvgAttributes: function(l) {
                if (l.setAttribute("xmlns", this.svgNS), l.setAttributeNS(this.xmlnsNS, "xmlns:xlink", this.xlinkNS), l.setAttributeNS(this.xmlnsNS, "xmlns:ev", this.evNS), null !== l.parentNode) {
                    var t = l.getAttribute("style") || ""; - 1 === t.toLowerCase().indexOf("overflow") && l.setAttribute("style", "overflow: hidden; " + t)
                }
            },
            internetExplorerRedisplayInterval: 300,
            refreshDefsGlobal: r.throttle(function() {
                for (var l = document.querySelectorAll("defs"), t = l.length, e = 0; e < t; e++) {
                    var o = l[e];
                    o.parentNode.insertBefore(o, o)
                }
            }, this ? this.internetExplorerRedisplayInterval : null),
            setCTM: function(l, t, e) {
                var o = this,
                    n = "matrix(" + t.a + "," + t.b + "," + t.c + "," + t.d + "," + t.e + "," + t.f + ")";
                l.setAttributeNS(null, "transform", n), "transform" in l.style ? l.style.transform = n : "-ms-transform" in l.style ? l.style["-ms-transform"] = n : "-webkit-transform" in l.style && (l.style["-webkit-transform"] = n), "ie" === i && e && (e.parentNode.insertBefore(e, e), window.setTimeout(function() {
                    o.refreshDefsGlobal()
                }, o.internetExplorerRedisplayInterval))
            },
            getEventPoint: function(l, t) {
                var e = t.createSVGPoint();
                return r.mouseAndTouchNormalize(l, t), e.x = l.clientX, e.y = l.clientY, e
            },
            getSvgCenterPoint: function(l, t, e) {
                return this.createSVGPoint(l, t / 2, e / 2)
            },
            createSVGPoint: function(l, t, e) {
                var o = l.createSVGPoint();
                return o.x = t, o.y = e, o
            }
        }
    }, {
        "./utilities": 7
    ...
    6: [function(l, t, e) {
        t.exports = function() {
            ...
            function o(l, t, e, o) {
                var n, i, s, a;
                n = "wheel" === h ? e : (i = l, s = e, a = function(l) {
                    !l && (l = window.event);
                    var t = {
                        originalEvent: l,
                        target: l.target || l.srcElement,
                        type: "wheel",
                        deltaMode: "MozMousePixelScroll" == l.type ? 0 : 1,
                        deltaX: 0,
                        delatZ: 0,
                    ...
                    return "mousewheel" == h ? (t.deltaY = -.025 * l.wheelDelta, l.wheelDeltaX && (t.deltaX = -.025 * l.wheelDeltaX)) : t.deltaY = l.detail, s(t)
                }, u.push({
                    element: i,
                    fn: a
                }), a), l[r](L + t, n, !!o && p)
            ...
            function n(l, t, e, o) {
                var n;
                n = "wheel" === h ? e : function(l) {
                        for (var t = 0; t < u.length; t++)
                            if (u[t].element === l) return u[t].fn;
                        return function() {}
                    }(l), l[i](L + t, n, !!o && p),
                    function(l) {
                        for (var t = 0; t < u.length; t++)
                            if (u[t].element === l) return u.splice(t, 1)
                    }(l)
            }
            return window.addEventListener ? (r = "addEventListener", i = "removeEventListener") : (r = "attachEvent", i = "detachEvent", L = "on"), h = "onwheel" in document.createElement("div") ? "wheel" : void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll", {
                on: function(l, t, e) {
                    o(l, h, t, e), "DOMMouseScroll" == h && o(l, "MozMousePixelScroll", t, e)
                },
                off: function(l, t, e) {
                    n(l, h, t, e), "DOMMouseScroll" == h && n(l, "MozMousePixelScroll", t, e)
                }
            }
        }()
    }, {}],
    7: [function(l, t, e) {
        function o(t) {
            return function(l) {
                window.setTimeout(l, t)
            }
        }
        t.exports = {
            extend: function(l, t) {
                for (var e in l = l || {}, t) this.isObject(t[e]) ? l[e] = this.extend(l[e], t[e]) : l[e] = t[e];
                return l
            },
            isElement: function(l) {
                return l instanceof HTMLElement || l instanceof SVGElement || l instanceof SVGSVGElement || l && "object" == typeof l && null !== l && 1 === l.nodeType && "string" == typeof l.nodeName
            },
            isObject: function(l) {
            ...
            getSvg: function(l) {
                var t, e;
                if (this.isElement(l)) t = l;
                else {
                    if (!("string" == typeof l || l instanceof String)) throw new Error("Provided selector is not an HTML object nor String");
                    if (!(t = document.querySelector(l))) throw new Error("Provided selector did not find any elements. Selector: " + l)
                }
                if ("svg" === t.tagName.toLowerCase()) e = t;
                else if ("object" === t.tagName.toLowerCase()) e = t.contentDocument.documentElement;
                else {
                    if ("embed" !== t.tagName.toLowerCase()) throw "img" === t.tagName.toLowerCase() ? new Error('Cannot script an SVG in an "img" element. Please use an "object" element or an in-line SVG.') : new Error("Cannot get SVG.");
                    e = t.getSVGDocument().documentElement
                }
                return e
            },
            proxy: function(l, t) {
            ...
            getType: function(l) {
                return Object.prototype.toString.apply(l).replace(/^\[object\s/, "").replace(/\]$/, "")
            },
            mouseAndTouchNormalize: function(l, t) {
                if (void 0 === l.clientX || null === l.clientX)
                    if (l.clientX = 0, void(l.clientY = 0) !== l.touches && l.touches.length) {
                        if (void 0 !== l.touches[0].clientX) l.clientX = l.touches[0].clientX, l.clientY = l.touches[0].clientY;
                        else if (void 0 !== l.touches[0].pageX) {
                            var e = t.getBoundingClientRect();
                            l.clientX = l.touches[0].pageX - e.left, l.clientY = l.touches[0].pageY - e.top
                        }
                    } else void 0 !== l.originalEvent && void 0 !== l.originalEvent.clientX && (l.clientX = l.originalEvent.clientX, l.clientY = l.originalEvent.clientY)
            },
            isDblClick: function(l, t) {
                if (2 === l.detail) return !0;
                if (null == t) return !1;
                var e = l.timeStamp - t.timeStamp,
                    o = Math.sqrt(Math.pow(l.clientX - t.clientX, 2) + Math.pow(l.clientY - t.clientY, 2));
                return e < 250 && o < 10
            },
            now: Date.now || function() {
                return (new Date).getTime()
            },
            throttle: function(e, o, n) {
                var i, s, a, r = this,
                    h = null,
                    L = 0;
                n || (n = {});
                var u = function() {
                    L = !1 === n.leading ? 0 : r.now(), h = null, a = e.apply(i, s), h || (i = s = null)
                };
                return function() {
                    var l = r.now();
                    L || !1 !== n.leading || (L = l);
                    var t = o - (l - L);
                    return i = this, s = arguments, t <= 0 || o < t ? (clearTimeout(h), h = null, L = l, a = e.apply(i, s), h || (i = s = null)) : h || !1 === n.trailing || (h = setTimeout(u, t)), a
                }
            },
            createRequestAnimationFrame: function(l) {
                var t = null;
                return "auto" !== l && l < 60 && 1 < l && (t = Math.floor(1e3 / l)), null === t ? window.requestAnimationFrame || o(33) : o(t)
            }
        }
    }, {}]
}, {}, [3]);
var svgMap = function(l) {
    this.init(l)
};
svgMap.prototype.init = function(l) {
        ...
        }, l || {}), this.options.targetElementID && document.getElementById(this.options.targetElementID) || this.error("Target element not found"), this.options.data || this.error("No data"), this.id = this.options.targetElementID, this.wrapper = document.getElementById(this.options.targetElementID), this.createMap(), this.applyData(this.options.data)
        ...
        ZM: "Zambia",
        ZW: "Zimbabwe"
    }, svgMap.prototype.applyData = function(i) {
        var s = null,
            a = null;
        Object.keys(i.values).forEach(function(l) {
            var t = parseInt(i.values[l][i.applyData], 10);
            null === s && (s = t), null === a && (a = t), s < t && (s = t), t < a && (a = t)
        }), i.data[i.applyData].thresholdMax && (s = Math.min(s, i.data[i.applyData].thresholdMax)), i.data[i.applyData].thresholdMin && (a = Math.max(a, i.data[i.applyData].thresholdMin)), Object.keys(this.countries).forEach(function(l) {
            var t = document.getElementById(this.id + "-map-country-" + l);
            if (t)
                if (i.values[l]) {
                    var e = Math.max(a, parseInt(i.values[l][i.applyData], 10)),
                        o = Math.max(0, Math.min(1, (e - a) / (s - a))),
                        n = this.getColor(this.options.colorMax, this.options.colorMin, o);
                    t.setAttribute("fill", n)
                } else t.setAttribute("fill", this.options.colorNoData)
        }.bind(this))
        ...
        this.createTooltip(), this.mapWrapper = this.createElement("div", "svgMap-map-wrapper", this.wrapper), this.mapImage = document.createElementNS("http://www.w3.org/2000/svg", "svg"), this.mapImage.setAttribute("viewBox", "0 0 2000 1001"), this.mapImage.classList.add("svgMap-map-image"), this.mapWrapper.appendChild(this.mapImage);
        var l = this.createElement("div", "svgMap-map-controls-wrapper", this.mapWrapper),
            e = this.createElement("div", "svgMap-map-controls-zoom", l);
        ["in", "out"].forEach(function(l) {
            var t = "zoomControl" + l.charAt(0).toUpperCase() + l.slice(1);
            this[t] = this.createElement("div", "svgMap-control-button svgMap-zoom-button svgMap-zoom-" + l + "-button", e), this[t].addEventListener("click", function() {
                this.zoomMap(l)
            }.bind(this))
        }.bind(this));
        var t = Object.assign({}, this.mapPaths);
        this.options.countries.EH || (t.MA.d = t["MA-EH"].d, delete t.EH), delete t["MA-EH"], Object.keys(t).forEach(function(l) {
            var t = this.mapPaths[l];
            if (t.d) {
                var e = document.createElementNS("http://www.w3.org/2000/svg", "path");
                e.setAttribute("d", t.d), e.setAttribute("id", this.id + "-map-country-" + l), e.setAttribute("data-id", l), e.classList.add("svgMap-country"), this.mapImage.appendChild(e), ["mouseenter", "touchdown"].forEach(function(l) {
                    e.addEventListener(l, function() {
                        e.closest("g").appendChild(e)
                    }.bind(this))
                }.bind(this)), e.addEventListener("touchstart", function(l) {
                    var t = e.getAttribute("data-id");
                    this.setTooltipContent(this.getTooltipContent(t)), this.showTooltip(l), this.moveTooltip(l)
                }.bind(this)), e.addEventListener("mouseenter", function(l) {
                    var t = e.getAttribute("data-id");
                    this.setTooltipContent(this.getTooltipContent(t)), this.showTooltip(l)
                }.bind(this)), e.addEventListener("mousemove", function(l) {
                    this.moveTooltip(l)
                }.bind(this)), ["mouseleave", "touchend"].forEach(function(l) {
                    e.addEventListener(l, function() {
                        this.hideTooltip()
                    }.bind(this))
                }.bind(this))
        ...
        this.mapPanZoom = svgPanZoom(this.mapImage, {
            ...
            onZoom: function() {
                h.setControlStatuses()
            },
            beforePan: function(l, t) {
                var e = .85 * h.mapWrapper.offsetWidth,
                    o = .85 * h.mapWrapper.offsetHeight,
                    n = this.getSizes(),
                    i = -(n.viewBox.x + n.viewBox.width) * n.realZoom + e,
                    s = n.width - e - n.viewBox.x * n.realZoom,
                    a = -(n.viewBox.y + n.viewBox.height) * n.realZoom + o,
                    r = n.height - o - n.viewBox.y * n.realZoom;
                return {
                    x: Math.max(i, Math.min(s, t.x)),
                    y: Math.max(a, Math.min(r, t.y))
                }
            }
        }), this.mapPanZoom.zoom(this.options.initialZoom), this.setControlStatuses()
    }, svgMap.prototype.getTooltipContent = function(o) {
        var l = this.createElement("div", "svgMap-tooltip-content-container");
        if (!1 === this.options.hideFlag) {
            var t = this.createElement("div", "svgMap-tooltip-flag-container svgMap-tooltip-flag-container-" + this.options.flagType, l);
            "image" === this.options.flagType ? this.createElement("img", "svgMap-tooltip-flag", t).setAttribute("src", this.options.flagURL.replace("{0}", o.toLowerCase())) : "emoji" === this.options.flagType && (t.innerHTML = this.emojiFlags[o])
        }
        this.createElement("div", "svgMap-tooltip-title", l).innerHTML = this.getCountryName(o);
        var e = this.createElement("div", "svgMap-tooltip-content", l);
        return this.options.data.values[o] ? (tooltipContentTable = "<table>", Object.keys(this.options.data.data).forEach(function(l) {
            var t = this.options.data.data[l],
                e = this.options.data.values[o][l];
            t.floatingNumbers && (e = e.toFixed(1)), t.thousandSeparator && (e = this.numberWithCommas(e, t.thousandSeparator)), e = t.format ? t.format.replace("{0}", "<span>" + e + "</span>") : "<span>" + e + "</span>", tooltipContentTable += "<tr><td>" + (t.name || "") + "</td><td>" + e + "</td></tr>"
        }.bind(this)), tooltipContentTable += "</table>", e.innerHTML = tooltipContentTable) : this.createElement("div", "svgMap-tooltip-no-data", e).innerHTML = this.options.noDataText, l
    }, svgMap.prototype.setControlStatuses = function() {
        this.zoomControlIn.classList.remove("svgMap-disabled"), this.zoomControlOut.classList.remove("svgMap-disabled"), this.mapPanZoom.getZoom().toFixed(3) <= this.options.minZoom && this.zoomControlOut.classList.add("svgMap-disabled"), this.mapPanZoom.getZoom().toFixed(3) >= this.options.maxZoom && this.zoomControlIn.classList.add("svgMap-disabled")
    }, svgMap.prototype.zoomMap = function(l) {
    ...
    }, svgMap.prototype.setTooltipContent = function(l) {
        this.tooltip && (this.tooltipContent.innerHTML = "", this.tooltipContent.append(l))
    }, svgMap.prototype.showTooltip = function(l) {
        this.tooltip.classList.add("svgMap-active"), this.moveTooltip(l)
    }, svgMap.prototype.hideTooltip = function() {
        this.tooltip.classList.remove("svgMap-active")
    }, svgMap.prototype.moveTooltip = function(l) {
        var t = l.pageX || (l.touches && l.touches[0] ? l.touches[0].pageX : null),
            e = l.pageY || (l.touches && l.touches[0] ? l.touches[0].pageY : null);
        if (null !== t && null !== e) {
            var o = window.innerWidth,
                n = this.tooltip.offsetWidth,
                i = this.tooltip.offsetHeight,
                s = t - n / 2;
            this.tooltipPointer.style.marginLeft = s <= 6 ? (t = 6 + n / 2, s - 6 + "px") : o - 6 <= s + n ? (t = o - 6 - n / 2, -1 * (o - 6 - l.pageX - n / 2) + "px") : "0px", e - 12 - i <= 6 ? (this.tooltip.classList.add("svgMap-tooltip-flipped"), e += 32) : (this.tooltip.classList.remove("svgMap-tooltip-flipped"), e -= 12), this.tooltip.style.left = t + "px", this.tooltip.style.top = e + "px"
        }
    }, svgMap.prototype.error = function(l) {
        (console.error || console.log)("svgMap error: " + (l || "Unknown error"))
    }, svgMap.prototype.createElement = function(l, t, e, o) {
        var n = document.createElement(l);
        return t && (t = t.split(" ")).forEach(function(l) {
            n.classList.add(l)
        }), o && (n.innerHTML = o), e && e.appendChild(n), n
    }, svgMap.prototype.numberWithCommas = function(l, t) {
        return l.toString().replace(/\B(?=(\d{3})+(?!\d))/g, t || ",")
    }, svgMap.prototype.getColor = function(l, t, e) {
        l = l.slice(-6), t = t.slice(-6);
        var o = Math.ceil(parseInt(l.substring(0, 2), 16) * e + parseInt(t.substring(0, 2), 16) * (1 - e)),
            n = Math.ceil(parseInt(l.substring(2, 4), 16) * e + parseInt(t.substring(2, 4), 16) * (1 - e)),
            i = Math.ceil(parseInt(l.substring(4, 6), 16) * e + parseInt(t.substring(4, 6), 16) * (1 - e));
        return "#" + this.getHex(o) + this.getHex(n) + this.getHex(i)
    }, svgMap.prototype.getHex = function(l) {
        return ("0" + (l = l.toString(16))).slice(-2)
    }, svgMap.prototype.getCountryName = function(l) {
        return this.options.countryNames && this.options.countryNames[l] ? this.options.countryNames[l] : this.countries[l]
    },
    function(l, t) {
        "function" == typeof define && define.amd ? define("svgMap", function() {
            return svgMap
        }) : "undefined" != typeof module && module.exports && (module.exports = svgMap, l.svgMap = svgMap)
    }(window, document);