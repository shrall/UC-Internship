                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input class="form-control" id="name" name="name" type="text" placeholder="Full Name"
                                    value="{{ $student->detailable->name }}" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="nim">NIM</label>
                            <input class="form-control" id="nim" name="nim" type="number" placeholder="NIM"
                                value="{{ $student->detailable->nim }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input class="form-control" id="email" name="email" type="text" placeholder="E-Mail"
                                    value="{{ $student->detailable->email }}" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div>
                                <label for="password"><span class="fa fa-key mr-2"></span>Password *<span
                                        class="text-muted">leave blank if you don't want to change it</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="phone" name="phone" type="number" placeholder="Phone Number"
                                value="{{ $student->detailable->phone }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="line_account" name="line_account" type="text"
                                placeholder="Line ID" value="{{ $student->detailable->line_account }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select w-100 mb-0" id="gender" name="gender">
                                <option value="M" @if ($student->detailable->gender == 'M')
                                    selected @endif >Male</option>
                                <option value="F" @if ($student->detailable->gender == 'F')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="batch" name="batch" type="number" placeholder="Year" min="2008"
                                max="{{ date('Y') }}" step="1" value="{{ $student->detailable->batch }}" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="gpa" name="gpa" type="number" placeholder="GPA" step="0.01"
                                value="{{ $student->info->gpa }}" required>
                        </div>
                    </div>
