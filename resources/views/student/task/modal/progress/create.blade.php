        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('student.progress.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <input class="form-control" id="time_start" name="time_start" type="datetime-local" placeholder="Time Start" required>

                    <label class="mt-3" for="end">Time End</label>
                    <input class="form-control" id="time_end" name="time_end" type="datetime-local" placeholder="Time End" required>
