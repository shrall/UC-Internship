...
@section('content')
    <div class="row">
        <div class="col-12 col-xl-8">
            <form action="{{ route('supervisor.lecturer.update', $lecturer->id) }}" method="POST">
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input class="form-control" id="full_name" type="text" placeholder="Enter your first name"
                                       value="{{$lecturer->detailable->name}}" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input class="form-control" id="address" type="text" placeholder="Enter your line id"
                                   value="{{$lecturer->detailable->line_account}}" required>
                        </div>
                    </div>
                ...
                <div class="col-12 mb-4">
                    <div class="card border-light text-center p-0">
                        ...
                        <div class="card-body pb-5"><img
                            ...
                            <h5 class="font-weight-normal">{{$lecturer->detailable->itle}}</h5>
                            <p class="text-gray mb-4">{{$lecturer->detailable->department->name}} ({{$lecturer->detailable->department->intial}})</p>
                        </div>
                    </div>
                </div>
            </div>
