...
@section('content')
                ...
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="{{ route('supervisor.project.edit', $project->id) }}">Edit Project</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('supervisor.project.update', $project->id) }}" method="POST" enctype="multipart/form-data">
...
{{--                                @if ($artwork->type == 'Ceramics') selected end="@endif"--}}
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="deadline" name="deadline" type="date" placeholder="Deadline" min="{{$currentperiod->start}}" max="{{$currentperiod->end}}" value="{{$project->deadline}}"required>
                        </div>
                        <div class="col-md-6 mb-3">
