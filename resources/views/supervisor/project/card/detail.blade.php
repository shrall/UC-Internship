...
<div class="card border-light shadow-sm text-center pt-3 pb-4 mb-4 mb-lg-0">
    <div class="card-body">
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group">
                <a href="{{ route('supervisor.project.edit', $project->id) }}"><button type="button" class="btn btn-sm btn-secondary"><span class="fa fa-cog"></span></button></a>
            </div>
        </div>
        ...
        <div class="medium font-weight-bold mt-1 text-warning"><span class="fa fa-hourglass-half"></span> Deadline :{{$project->deadline}}</div>
